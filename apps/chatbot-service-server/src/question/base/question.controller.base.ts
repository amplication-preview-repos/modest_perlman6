...
import { HintFindManyArgs } from "../../hint/base/HintFindManyArgs";
...
export class QuestionControllerBase {
  ...
  async findHints(
    ...
    const query = plainToClass(HintFindManyArgs, request.query);
    const results = await this.service.findHints(params.id, {
      ...query,
      select: {
        content: true,
        createdAt: true,
  ...
  async connectHints(
    @common.Param() params: QuestionWhereUniqueInput,
    @common.Body() body: HintWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      hints: {
        connect: body,
  ...
  @common.Delete("/:id/hints")
  @nestAccessControl.UseRoles({
    resource: "Question",
    action: "update",
    possession: "any",
  })
  async disconnectHints(
    @common.Param() params: QuestionWhereUniqueInput,
    @common.Body() body: HintWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  async SubmitQuestion(
    ...
    return this.service.SubmitQuestion(body);
  }
}
