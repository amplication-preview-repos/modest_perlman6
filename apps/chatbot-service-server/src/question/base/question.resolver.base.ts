...
export class QuestionResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [Hint], { name: "hints" })
  @nestAccessControl.UseRoles({
    resource: "Hint",
    action: "read",
    possession: "any",
  ...
  async findHints(
    ...
    @graphql.Args() args: HintFindManyArgs
  ): Promise<Hint[]> {
    const results = await this.service.findHints(parent.id, args);
  ...
  async SubmitQuestion(
    @graphql.Args()
    args: QuestionCreateInput
  ): Promise<Question> {
    return this.service.SubmitQuestion(args);
  }
}
